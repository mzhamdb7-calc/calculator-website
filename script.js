...
/* =====================================================
   ADD REFERENCE BOX UNDER INSTRUCTIONS
   Applies to all pages that have .instruction-box
===================================================== */
(function () {
  "use strict";
  ...
  function makeReferenceCard(title, text) {
    const card = document.createElement("div");
    card.className = "reference-card";
  ...
  function addReferenceBox() {
    ...
    if (instructionBox.querySelector(".reference-box")) return;
    ...
    data.forEach(function (item) {
      scrollArea.appendChild(makeReferenceCard(item[0], item[1]));
    });
  ...
  function startReferenceBox() {
    ...
    setTimeout(addReferenceBox, 150);
    setTimeout(addReferenceBox, 500);
    setTimeout(addReferenceBox, 1000);
  }
