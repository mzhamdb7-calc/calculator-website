...
/* =====================================================
   REMOVE NON-BASIC HISTORY BOXES FROM DOM
   - Basic calculator history stays
   - Other calculator history boxes are removed, not hidden
   - Also adds no-history-layout class for layout cleanup
===================================================== */
(function () {
  "use strict";
  ...
  function getPageType() {
    ...
    if (document.body.classList.contains("basic-page") || document.body.dataset.page === "basic" || document.getElementById("display") || title.includes("basic")) return "basic";
    if (document.body.classList.contains("age-page") || document.body.dataset.page === "age" || document.getElementById("birthdate") || title.includes("age")) return "age";
    if (document.body.classList.contains("bmi-page") || document.body.dataset.page === "bmi" || document.getElementById("bmiResult") || title.includes("bmi")) return "bmi";
    if (document.body.classList.contains("loan-page") || document.body.dataset.page === "loan" || document.getElementById("loanResult") || title.includes("loan") || title.includes("mortgage")) return "loan";
    if (document.body.classList.contains("discount-page") || document.body.dataset.page === "discount" || document.getElementById("discountResult") || title.includes("discount")) return "discount";
    if (document.body.classList.contains("percentage-page") || document.body.dataset.page === "percentage" || document.getElementById("percentageResult") || title.includes("percentage")) return "percentage";
    if (document.body.classList.contains("compound-page") || document.body.dataset.page === "compound" || document.getElementById("compoundResult") || title.includes("compound")) return "compound";
  ...
  function removeNonBasicHistoryBoxes() {
    ...
    document.querySelectorAll(
      ...
      ".bmi-history-box, " +
      ".loan-history-box, " +
      ".discount-history-box, " +
      ".percentage-history-box, " +
      ".compound-history-box"
  ...
  function start() {
    ...
    setTimeout(removeNonBasicHistoryBoxes, 100);
    setTimeout(removeNonBasicHistoryBoxes, 500);
    setTimeout(removeNonBasicHistoryBoxes, 1200);
  }
